...
import com.example.playlist_management.factory.PlaylistWindowFactory;
import com.example.playlist_management.repository.AuthRepository;
    ...
    private void handleLogin(ActionEvent event) {
        ...
        try {
            if (authRepository.authenticate(username, password)) {
                ...
                Scene scene = PlaylistWindowFactory.createScene();
                stage.setTitle("Music Playlist Management");
